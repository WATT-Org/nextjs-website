...
const Blogs = () => {
  ...
  return (
    <div className="px-4 py-6">
      ...
      <h1 className="text-center text-white my-8 text-3xl font-bold underline underline-offset-4 p">
      ...
      <div className="grid grid-cols-3 gap-x-4 items-center">
        {blogs.map((blog) => (
          <div
            key={blog.slug}
            className="11/12 px-6 py-4 rounded-md bg-gray-700 border border-white"
          >
